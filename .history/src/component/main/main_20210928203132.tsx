...
import { dataInitalState, readData, updateUserId } from "../../store";
...
const Main = ({
  ...
  useEffect(() => {
    ...
    dataService.readData(userId, (serverData: InitData) => {
      serverData && dispatch(readData(serverData));
    });
  ...
  const onDragEnd = useCallback(
    (result: DropResult) => {
      ...
      dispatch(readData(newData));
    },
    [data, dataService, userId, dispatch]
  );
